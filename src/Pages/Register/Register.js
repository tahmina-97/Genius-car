            ...
            <div className="w-full border-2 border-light-text  max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
                ...
                <form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="username" id="username" placeholder="Your name" className="w-full px-2 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label for="username" className="block dark:text-gray-400">Email</label>
                        <input type="email" name="username" id="username" placeholder="Your email" className="w-full px-2 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
